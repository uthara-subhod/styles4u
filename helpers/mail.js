...
const otpEmail = async (body, otp) => {
  try {
    ...
    const mailOptions = {
      from: "styles4ubusiness@gmail.com",
      to: body.email,
      subject: "Otp verification to signup",
      html: `<!doctype html>
        <html>
          <head>
              ...
              <tr>
                ...
                <td class="container">
                  <div class="content">
                    ...
                    <h1 class="m-0 px-4 display-5">Styles<span class="text-primary px-1 mr-1">4U</span></h1>
                        ...
                        <td class="wrapper">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>
                                <p>Hi there,</p>
                                <p>Thank you for choosing our platform. As an additional security measure, we have generated a One-Time Password (OTP) for you to complete the login process.<br><br>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="content-block">
                            <span class="apple-link">Styles4u Inc, 3 Thaalikaavu Road, India CA 94102</span>
                            <br>
                          </td>
                        </tr>
                        <tr>
